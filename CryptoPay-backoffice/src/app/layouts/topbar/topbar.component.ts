...
import { ModifyPasswordModalResult } from 'src/app/shared/interfaces/login';
...
export class TopbarComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  resetPassword() {
    this.modalService.open<ResetPassComponent, any, ModifyPasswordModalResult>(ResetPassComponent, {
      width: '500px',
      disableClose: true,
    });
  }
