...
export const fadeFastInSlowOut: AnimationTriggerMetadata = trigger('fadeFastInSlowOut', [
  transition(':enter', [style({ opacity: 0 }), animate(`${AnimationDuration.FAST}`, style({ opacity: 1 }))]),
