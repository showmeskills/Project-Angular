 ...
 * @since 4.1.0
 */
@Directive({ selector: 'ng-template[ngPaginationEllipsis]', standalone: true })
 ...
 * @since 4.1.0
 */
@Directive({ selector: 'ng-template[ngPaginationFirst]', standalone: true })
 ...
 * @since 4.1.0
 */
@Directive({ selector: 'ng-template[ngPaginationLast]', standalone: true })
 ...
 * @since 4.1.0
 */
@Directive({ selector: 'ng-template[ngPaginationNext]', standalone: true })
 ...
 * @since 4.1.0
 */
@Directive({ selector: 'ng-template[ngPaginationNumber]', standalone: true })
 ...
 * @since 4.1.0
 */
@Directive({ selector: 'ng-template[ngPaginationPrevious]', standalone: true })
...
export class NgPagination implements OnChanges {
  ...
  onFirstAndLast($event, isFirst = false) {
    $event.preventDefault();

    const first = Math.max(this.page - 10, 1);
    const next = Math.min(this.page + 10, this.pageCount);

    this.selectPage(isFirst ? first : next);
  }
}
