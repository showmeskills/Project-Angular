...
import { OwlDialogConfig } from 'src/app/components/datetime-picker/lib/dialog/dialog-config.class';
...
import { extendObject } from 'src/app/components/datetime-picker/lib/utils';
...
export class OwlDialogService {
  ...
  private attachDialogContent<T>(
    ...
    const dialogRef = new OwlDialogRef<T>(overlayRef, dialogContainer, config.id as string, this.location);
