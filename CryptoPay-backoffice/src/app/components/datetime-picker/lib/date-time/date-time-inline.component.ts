...
import { OwlDateTimeContainerComponent as OwlDateTimeContainerComponent_1 } from './date-time-picker-container.component';
...
@Component({
  ...
  standalone: true,
  imports: [OwlDateTimeContainerComponent_1],
})
export class OwlDateTimeInlineComponent<T> extends OwlDateTime<T> implements OnInit, ControlValueAccessor {
  ...
  get startAt(): T | null {
    ...
    } else if (this.selectMode === 'range' || this.selectMode === 'date-range' || this.selectMode === 'rangeFrom') {
