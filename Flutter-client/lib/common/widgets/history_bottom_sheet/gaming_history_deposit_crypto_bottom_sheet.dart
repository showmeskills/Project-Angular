...
class GamingHistoryDepositCryptoBottomSheet {
  static Future<void> show({
    ...
    return GamingBottomSheet.show<DateTime>(
      ...
      fixedHeight: false,
      builder: (context) {
        return _GamingHistoryDepositCryptoBottomSheetItem(
          data: data,
        );
      },
    );
...
class _GamingHistoryDepositCryptoBottomSheetItem extends StatelessWidget
    with DepositCommonUtilsMixin {
  const _GamingHistoryDepositCryptoBottomSheetItem({
    required this.data,
  });
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Visibility(visible: data.txid.isNotEmpty, child: Gaps.vGap18),
