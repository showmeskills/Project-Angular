...
import 'fiat_withdraw_to_eb_result_logic.dart';

class FiatWithdrawToEBResultPage extends BaseView<FiatWithdrawToEBResultLogic> {
  const FiatWithdrawToEBResultPage({
    super.key,
  ...
  Widget body(BuildContext context) {
    Get.put(FiatWithdrawToEBResultLogic());
      ...
      children: [
        Column(
          ...
          children: [
            ...
            Gaps.vGap4,
            _buildStepInfo(content: localized("wait_trans_processing")),
            Gaps.vGap4,
            _buildStep('4', localized("finish")),
            Gaps.vGap4,
            _buildStepInfo(
...
extension _Action on FiatWithdrawToEBResultPage {
  void submit() {
    controller.close();
  }
}
