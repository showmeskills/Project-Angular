...
part 'gaming_lucky_spin_state.dart';

class GamingLuckySpinLogic extends BaseController
    with GetTickerProviderStateMixin {
  final state = GamingLuckySpinState();
  // late AudioPool pool;
  ...
  int getCurType() {
    if (state.isLogin.value == false) {
      return 0;
    } else if (GGUtil.parseInt(state.gapModel?.leftTimes) > 0) {
      return 1;
