part of 'gaming_lucky_spin_view.dart';

class GamingLuckySpinInfoDetailView extends StatefulWidget {
  const GamingLuckySpinInfoDetailView({
    Key? key,
  }) : super(key: key);

  @override
  State<GamingLuckySpinInfoDetailView> createState() =>
      _GamingLuckySpinInfoDetailViewState();
}

class _GamingLuckySpinInfoDetailViewState
    extends State<GamingLuckySpinInfoDetailView> {
  GamingLuckySpinLogic get baseController => Get.find<GamingLuckySpinLogic>();
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            ...
            left: 26.dp,
            child: Text(
              baseController.state.informationModel?.slogan ?? '',
              style: GGTextStyle(
        ...
        Container(
            ...
            child: Obx(() {
              return Row(
                ...
                children: [
                  _buildTimeItem(hours.value, localized('hour_unit')),
                  Gaps.hGap24,
                  _buildTimeItem(minutes.value, localized('minu')),
                  Gaps.hGap24,
                  _buildTimeItem(second.value, localized('second_unit')),
                  // Gaps.hGap24,
                ],
              );
            })),
