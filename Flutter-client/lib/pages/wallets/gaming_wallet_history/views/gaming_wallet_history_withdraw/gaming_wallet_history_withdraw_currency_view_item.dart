...
import 'bottom_sheet/gaming_withdraw_currency_pop_detail_view.dart';

class GamingWalletHistoryWithdrawCurrencyViewItem extends StatelessWidget
    with DepositCommonUtilsMixin {
  const GamingWalletHistoryWithdrawCurrencyViewItem(
...
extension _Action on GamingWalletHistoryWithdrawCurrencyViewItem {
  void _onClickDetail() {
