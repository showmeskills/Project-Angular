...
class GamingWalletHistoryWithdrawCryptoViewItem extends StatelessWidget
    with DepositCommonUtilsMixin {
  const GamingWalletHistoryWithdrawCryptoViewItem(
  ...
  Widget _buildBody() {
    return Column(
      children: [
        ...
        _buildRow(localized('trans_network'), data.network),
        Gaps.vGap10,
        Row(
          children: [
            Text(data.timeToMM,
...
extension _Action on GamingWalletHistoryWithdrawCryptoViewItem {
  void _onClickDetail() {
