...
import 'gaming_provider_label_selector_logic.dart';

class GamingSelectProviderLabelSelector extends StatelessWidget {
  const GamingSelectProviderLabelSelector({
    super.key,
            ...
            return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  bool isSelect = logic.selectProviderIds
                      .contains(logic.providers[index].code);
                  return InkWell(
                    onTap: () {
                      logic.selectProvider(logic.providers[index].code);
                    },
                    child: SizedBox(
                      height: 50.dp,
                      child: Row(
