...
import 'gaming_unbind_google_logic.dart';

class GamingUnbindGoogleView extends BaseView<GamingUnbindGoogleLogic> {
  const GamingUnbindGoogleView({Key? key}) : super(key: key);
  ...
  PreferredSizeWidget? appBar(BuildContext context) {
    return GGAppBar.normal(title: localized('un_google_auth'));
  }
  ...
  Widget _contentWidget(BuildContext context) {
    Get.put(GamingUnbindGoogleLogic());
    return Container(
  ...
  Widget _buildContent1() {
    return Column(
      ...
      children: [
        ...
        Gaps.vGap16,
        Visibility(
          visible: controller.isBindMobileValid(),
          child: Text(localized('p_code'),
              style: GGTextStyle(
        ...
        Visibility(
          visible: controller.isBindMobileValid(),
          child: MobileVerificationCodeWidget(
  ...
  Widget _buildSuccess(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          _buildTip(localized('un_auth'), weight: GGFontWeigh.regular),
          Gaps.vGap30,
          Image.asset(
            R.iconBindSuccess,
            width: 92.dp,
          ...
          Gaps.vGap26,
          _buildTextSecond(localized('success_unbind')),
        ],
      ),
    );
  }
