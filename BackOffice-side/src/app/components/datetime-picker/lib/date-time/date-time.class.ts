...
export type SelectMode = 'single' | 'date-range' | 'range' | 'rangeFrom' | 'rangeTo';
...
export abstract class OwlDateTime<T> {
  ...
  get formatString(): string {
    return this.pickerType === 'both'
      ? this.showSecondsTimer
        ? this.dateTimeFormats.fullTimePickerInput
