...
@Component({
  selector: 'report-Lottery-list-detail',
...
export class ReportLotteryListDetailComponent implements OnInit {
  constructor(@Optional() public modal: MatModalRef<ReportLotteryListDetailComponent>) {}
