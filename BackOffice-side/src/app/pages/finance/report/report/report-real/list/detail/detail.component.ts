...
@Component({
  selector: 'report-real-list-detail',
...
export class ReportRealListDetailComponent implements OnInit {
  constructor(@Optional() public modal: MatModalRef<ReportRealListDetailComponent>) {}
