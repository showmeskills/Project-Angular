...
@Component({
  selector: 'extra-reward-record',
  templateUrl: './extra-reward-record.component.html',
  styleUrls: ['./extra-reward-record.component.scss'],
  standalone: true,
  imports: [
    FormRowComponent,
...
export class ExtraRewardRecordComponent implements OnInit {
  constructor(
  ...
  async exportExcel(list: any[]) {
    ...
    JSONToExcelDownload(exportList, 'eWalletDepBonus-prize-record ' + Date.now());
  }
}
