...
export class DepositCodeComponent implements OnInit {
  constructor(
    ...
    // 必须：活动初始化设置
    this.curType = ActivityTypeEnum.CouponCodeDeposit;
    this.instance = depositCodeInstance;
  }
  ...
  async onExport() {
    ...
    const bonusCode = await this.lang.getOne('member.activity.sencli14.bonusCode');
    ...
    JSONToExcelDownload(exportList, 'deposit-code ' + Date.now());
  }
