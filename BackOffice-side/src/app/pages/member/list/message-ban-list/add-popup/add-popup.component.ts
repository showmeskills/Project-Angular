...
@Component({
  selector: 'message-ban-list-add-popup',
...
export class MessageBanListAddPopupComponent implements OnInit {
  constructor(
    public modal: MatModalRef<MessageBanListAddPopupComponent, boolean>,
  ...
  onSubmit() {
    ...
    this.appService.isContentLoadingSubject.next(true);
    this.api.addMessageBanList({ uids, tenantId: this.tenantId }).subscribe((res) => {
      this.appService.isContentLoadingSubject.next(false);
