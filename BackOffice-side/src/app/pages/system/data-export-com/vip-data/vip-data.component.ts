...
import { VipDataItem } from 'src/app/shared/interfaces/stat';
...
@Component({
  ...
  templateUrl: './vip-data.component.html',
  styleUrls: ['./vip-data.component.scss'],
  providers: [DestroyService],
})
export class VipDataComponent implements OnInit {
  constructor(
