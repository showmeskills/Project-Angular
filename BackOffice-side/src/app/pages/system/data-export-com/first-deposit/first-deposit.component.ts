...
import { FirstDepositItem } from 'src/app/shared/interfaces/stat';
import { PageSizes, PaginatorState } from 'src/app/_metronic/shared/crud-table';
import { CurrencyValuePipe } from 'src/app/shared/pipes/currency-value.pipe';

@Component({
  selector: 'first-deposit',
  standalone: true,
  imports: [
    CommonModule,
  ...
  styleUrls: ['./first-deposit.component.scss'],
  providers: [DestroyService],
})
export class FirstDepositComponent implements OnInit {
  constructor(
  ...
  loadData(resetPage = false) {
    ...
    this.api
      .getFirstDepositData(this.getParams())
