...
import { ProviderggrItem } from 'src/app/shared/interfaces/stat';
import { PageSizes, PaginatorState } from 'src/app/_metronic/shared/crud-table';
import { CurrencyValuePipe } from 'src/app/shared/pipes/currency-value.pipe';

@Component({
  selector: 'providerggr',
  standalone: true,
  imports: [
    CommonModule,
  ...
  templateUrl: './providerggr.component.html',
  styleUrls: ['./providerggr.component.scss'],
  providers: [DestroyService],
})
export class ProviderggrComponent implements OnInit {
  constructor(
  ...
  loadData(resetPage = false) {
    ...
    this.api
      .getProviderggrData(this.getParams())
