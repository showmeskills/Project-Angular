...
import { BonusPrizeTypeSelect, PlayerBonusDownbreak } from 'src/app/shared/interfaces/stat';
import { PageSizes, PaginatorState } from 'src/app/_metronic/shared/crud-table';
import { CurrencyValuePipe } from 'src/app/shared/pipes/currency-value.pipe';

@Component({
  selector: 'player-bonus-breakdown',
  standalone: true,
  imports: [
    CommonModule,
  ...
  templateUrl: './player-bonus-breakdown.component.html',
  styleUrls: ['./player-bonus-breakdown.component.scss'],
  providers: [DestroyService],
})
export class PlayerBonusBreakdown implements OnInit {
  constructor(
  ...
  loadData(resetPage = false) {
    ...
    this.api
      .getPalyerBonusBreakdown(this.getParams)
