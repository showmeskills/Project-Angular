...
import { ViewContainerRef, ComponentFactoryResolver, Injector, Provider } from '@angular/core';
 ...
 */
export class MatModalConfig<D = any> {
  /**
  ...
  /** Custom class for the overlay root. */
  hostClass?: string | string[] = '';

  /** Custom class for the overlay wrapper. */
  ...
  /** Layout direction for the modal's content. */
  direction?: Direction;
