...
var KTLayoutChat = (function () {
  ...
  var _handeMessaging = function (element) {
    ...
    html +=
      '		<a href="#" class="text-dark-75 text-hover-primary fw-bold font-size-h6">You</a>';
    html += "	</div>";
    ...
    html += "</div>";
    html +=
      '<div class="mt-2 rounded p-5 bg-light-primary text-dark-50 fw-bold font-size-lg text-right max-w-400px">' +
      textarea.value +
      "</div>";
    ...
    setTimeout(function () {
      ...
      html += "	<div>";
      html +=
        '		<a href="#" class="text-dark-75 text-hover-primary fw-bold font-size-h6">Matt Pears</a>';
      html += '		<span class="text-muted font-size-sm">Just now</span>';
      html += "	</div>";
      html += "</div>";
      html +=
        '<div class="mt-2 rounded p-5 bg-light-success text-dark-50 fw-bold font-size-lg text-left max-w-400px">';
